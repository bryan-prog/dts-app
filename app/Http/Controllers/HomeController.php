...
class HomeController extends Controller
{
    ...
    public function mayors_approval(Request $request)
    {
        ...
        {
            $data = ['number'=>$original_sender->contact, 'message'=>'The document with the tracking number '.$document->tracking_number. ' has been approved at ' . Carbon::now() . ' by the mayor.'];
            $data2 = ['number'=>$receiver->contact, 'message'=>'The document with the tracking number '.$document->tracking_number. ' has been approved at ' . Carbon::now() . ' by the mayor.'];
        ...
        {
            $data = ['number'=>$original_sender->contact, 'message'=>'The document with the tracking number '.$document->tracking_number. ' has been tagged as For Review at ' . Carbon::now() . ' by the mayor.'];
            $data2 = ['number'=>$receiver->contact, 'message'=>'The document with the tracking number '.$document->tracking_number. ' has been tagged as For Review at ' . Carbon::now() . ' by the mayor.'];
        ...
        {
            $data = ['number'=>$original_sender->contact, 'message'=>'The document with the tracking number '.$document->tracking_number. ' has been disapproved at ' . Carbon::now() . ' by the mayor.'];
            $data2 = ['number'=>$receiver->contact, 'message'=>'The document with the tracking number '.$document->tracking_number. ' has been disapproved at ' . Carbon::now() . ' by the mayor.'];
